...
LOGIN_REDIRECT_URL_PARAM_NAME = "next"
# PASSWORDS
# ------------------------------------------------------------------------------
...
TEMPLATES = [
    {
        ...
        "OPTIONS": {
            ...
            "context_processors": [
                ...
                "saas_base.users.context_processors.allauth_settings",
            ],
        },
    },
]
...
ADMINS = [("""James""", "cactuscatllc@gmail.com")]
...
STRIPE_WEBHOOK_SECRET = STRIPE_LIVE_WEBHOOK_SECRET if STRIPE_LIVE_MODE else STRIPE_TEST_WEBHOOK_SECRET
