# Generated by Django 5.1.8 on 2025-06-18 22:18
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.CharField(choices=[('art', 'Artistic'), ('photo', 'Photography'), ('fantasy', 'Fantasy'), ('nature', 'Nature'), ('portrait', 'Portrait'), ('abstract', 'Abstract'), ('vintage', 'Vintage'), ('modern', 'Modern')], max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('prompt_template', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='image_processing.prompttemplate')),
            ],
        ),
        migrations.CreateModel(
            name='ImageRating',
            fields=[
                ...
                ('processed_image', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='ratings', to='image_processing.processedimage')),
            ],
            options={
                'ordering': ['-created_at'],
        ...
        migrations.AddField(
            ...
            name='prompts',
            field=models.ManyToManyField(related_name='processing_jobs', to='image_processing.prompttemplate'),
        ),
        migrations.CreateModel(
            name='UserImage',
            fields=[
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('tag', models.CharField(choices=[('too_dark', 'Too Dark'), ('too_bright', 'Too Bright'), ('wrong_style', 'Wrong Style'), ('poor_quality', 'Poor Quality'), ('unrealistic', 'Unrealistic'), ('missing_details', 'Missing Details'), ('color_issues', 'Color Issues'), ('composition', 'Poor Composition'), ('artifacts', 'Visual Artifacts'), ('other', 'Other')], max_length=20)),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('rating', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='tags', to='image_processing.imagerating')),
            ],
            options={
                'unique_together': {('rating', 'tag')},
            },
        ),
        migrations.CreateModel(
            name='Favorite',
